...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "--1002231672628"))

# Get this value from @gundayrules on Telegram by /id
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/ladli_chatting_world")
...
if SUPPORT_CHANNEL:
    if not re.match("(?:http|https)://", SUPPORT_CHANNEL):https://t.me/Gundayrules
        raise SystemExit(
